class ExploreController < ApplicationController
  ...
  def get_random_playlists
    ...
    playlists_records = Playlist.includes(:videos).where(:id => Video.connection.select_values("SELECT playlist_id FROM videos GROUP BY videos.playlist_id HAVING COUNT(*) > 5")).limit(params[:limit])
